...
trait StatusTrait
{
    ...
    {
        return [
            IActiveStatus::STATUS_INACTIVE => Module::t('blog', 'Inactive'),
            IActiveStatus::STATUS_ACTIVE => Module::t('blog', 'Active'),
            IActiveStatus::STATUS_ARCHIVE => Module::t('blog', 'Deleted')
        ];
    }
